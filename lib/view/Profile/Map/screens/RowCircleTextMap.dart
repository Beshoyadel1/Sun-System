...
class RowCircleTextMap extends StatelessWidget {
  const RowCircleTextMap({super.key});

  @override
  Widget build(BuildContext context) {
    return Row(
      children: [
        Image.asset(ImagePath.circle34, width: 50),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              AppText(
                text: LanguagePath.yourGeographicLocation,
              ...
              AppText(
                text: LanguagePath.toViewServicesNearYou,
                style: Fontspath.appTextStyle(
                  fontSize: 16,
