...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'ar': {
      'giftWarranty': 'هدية الضمان',
      'congratulationsGift': 'مبروووووك، لقد حصلت علي',
      'warrantyGift': 'هدية',
      'warrantySun': 'ضمان صن',
      'fiveYearsGift': 'لمدة 5 سنوات هدية',
      'warrantySunFeatures': 'مميزات ضمان صن',
      'benefitFromServiceWarranty': 'الاستفادة من ضمان الخدمات عبر مراكزنا المتعمدة',
      'carsWarrantyMarket': 'ضمان السيارات من بيع وشراء في حراج السيارات',
      'freeMaintenanceDuringWarranty': 'تقديم خدمات صيانة مجانية طوال فترة الضمان',
      'serviceMaintenance': 'خدمات الصيانة والاصلاح',
      'serviceOilChange': 'تغيير الزيوت',
      'serviceHighways': 'الطرق السريعة',
      'serviceElectricity': 'كهرباء سيارات',
      'serviceSpareParts': 'قطع الغيار',
      'serviceMobile': 'صيانة متنقلة',
      'serviceCarMarket': 'حراج سيارات',
      'serviceTransport': 'خدمة النقل',
      'chooseYourFavoriteServices':'أختر الخدمات المفضلة',
      'favoriteServices':'الخدمات المفضلة',
      'youCanSelectOurFavoriteServices':'يمكنك تحديد الخدمات المفضلة لدينا',
      'searchYourAddress':'بحث عنوانك',
      'yourGeographicLocation':'موقعك الجغرافي',
      'toViewServicesNearYou':'لاستعراض خدمات قريبة منك',
      ...
      'resend': 'إعادة ارسال',
      'showServicesNow': 'عرض الخدمات الأن',
    },
    'en': {
      'giftWarranty': 'Warranty Gift',
      'congratulationsGift': 'Congratulations, you got',
      'warrantyGift': 'Gift',
      'warrantySun': 'Sun Warranty',
      'fiveYearsGift': 'Gift for 5 years',
      'warrantySunFeatures': 'Sun Warranty Features',
      'benefitFromServiceWarranty': 'Benefit from warranty services via our authorized centers',
      'carsWarrantyMarket': 'Car warranty from buying and selling in the car market',
      'freeMaintenanceDuringWarranty': 'Free maintenance services throughout the warranty period',
      'serviceMaintenance': 'Maintenance Services',
      'serviceOilChange': 'Oil Change',
      'serviceHighways': 'Highways',
      'serviceElectricity': 'Car Electricity',
      'serviceSpareParts': 'Spare Parts',
      'serviceMobile': 'Mobile Maintenance',
      'serviceCarMarket': 'Car Market',
      'serviceTransport': 'Transport Service',
      'chooseYourFavoriteServices':'Choose your favorite services',
      'favoriteServices':'Favorite Services',
      'youCanSelectOurFavoriteServices':'You can select our favorite services',
      'searchYourAddress':'Search your address',
      'yourGeographicLocation':'Your geographic location',
      'toViewServicesNearYou':'To view services near you',
      ...
      'resend': 'Resend',
      'showServicesNow': 'Show Services Now',
    },
  };
